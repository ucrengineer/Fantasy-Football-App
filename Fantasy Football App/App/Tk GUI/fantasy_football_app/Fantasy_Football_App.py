...
class LoginScreen(tk.Frame):
    ...
    def graph_team(self):
        ...
        fig.add_subplot(111).set_title("Fantasy Points Allowed(Lower Rank ~ More Fantasay Points Allowed)")
